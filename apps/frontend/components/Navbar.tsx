    ...
    <div ref={wrapperRef} className="relative">
      <form onSubmit={(e) => { e.preventDefault(); go(query); }} className="relative">
        <input
          ...
          className="w-56 h-9 pl-9 pr-8 rounded-lg bg-gray-100 border border-transparent text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:bg-white focus:border-gray-300 focus:ring-2 focus:ring-blue-500/20 transition-all"
        />
      ...
      {isOpen && suggestions.length > 0 && (
        <div className="absolute right-0 z-50 w-72 mt-1.5 bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-bold text-gray-900">Quantiv</span>
            </Link>
