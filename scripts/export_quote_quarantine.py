    ...
    conn.execute(
        ...
        COPY (
            SELECT
                ...
                source_quote_timestamp AS quote_timestamp,
                NULL::TIMESTAMP AS call_quote_timestamp,
                NULL::TIMESTAMP AS put_quote_timestamp,
            ...
            SELECT
                ...
                COALESCE(call_quote_timestamp, put_quote_timestamp) AS quote_timestamp,
